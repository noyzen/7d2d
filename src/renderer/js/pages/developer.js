...
function createConfigRuleElement(rule) {
    ...
    ruleEl.innerHTML = `
        ...
        <div class="config-rule-body">
            ...
            <div class="config-field"><label>New Line Content (use ##7d2dlauncher-username##)</label><input type="text" data-key="lineTemplate" value="${rule.lineTemplate || ''}" placeholder="e.g., UserName=##7d2dlauncher-username##"></div>
        </div>`;
...
function createRegistryRuleElement(rule) {
    ...
    ruleEl.innerHTML = `
        ...
        <div class="registry-rule-body">
            ...
            <div class="config-field"><label>Key Value Template (use ##7d2dlauncher-username##)</label><input type="text" data-key="keyValueTemplate" value="${rule.keyValueTemplate || ''}" placeholder="e.g., ##7d2dlauncher-username##"></div>
        </div>`;
